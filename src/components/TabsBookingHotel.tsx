...
const TabsBooking = () => {
  ...
  return (
    <div className="  bg-c8 dark:bg-c1 dark:bg-opacity-95  shadow-c5  dark:shadow-c2 sticky mt-[-180px]  rounded-xl md:mt-[-100px] md:ml-14 md:mr-14 max-w-5xl mx-auto ml-8 mr-8 shadow-2xl pb-6 ">
      <Tabs
        value={value}
