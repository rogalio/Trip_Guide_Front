...
const DestinationCard = () => {
  return (
    <div className="max-w-5xl mx-8 mt-10 font-DmSans md:mx-auto md:mt-12 md:px-6">
      ...
      <p className="px-2 mt-4 text-center text-md text-c4 md:text-base dark:text-c5">
      ...
      <div className="flex gap-4 pb-8 overflow-x-scroll md:grid md:grid-cols-3 md:scrollbar-hide lg:grid-cols-4 ">
        <div className=" flex flex-col gap-2 w-[250px] min-w-[230px]    md:w-[240px] hover:bg-c7 dark:hover:bg-c2 hover:shadow-md  md:h-[180px] mt-6 p-4 border-c6 dark:border-c3 border-[1px] rounded-lg shadow-md">
          <img
